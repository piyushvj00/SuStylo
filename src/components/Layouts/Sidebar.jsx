...
const Sidebar = ({ isCollapsed }) => {
  ...
  const businessSubItems = [
    { name: "Salons", Icon: SalonIcon, path: "/businesses/salons" },
    { name: "Freelancers", Icon: FreelancerIcon, path: "/businesses/freelancers" },
  ];
          ...
          <div key={name}>
            {name === "Businesses" ? (
              <>
                ...
                <div className={`overflow-hidden transition-all duration-300 ease-in-out ${isBusinessOpen && !isCollapsed ? 'max-h-96' : 'max-h-0'
                  }`}>
                  <div className="ml-6 mt-1 space-y-1 text-sm">
