...
//                 setExistingCoverImage(blogData.coverImage || '');
                
//                 setFormData({
//                     title: blogData.title || '',
//                     slug: blogData.slug || '',
//                     author: blogData.author?._id || blogData.author || '',
//                     tags: Array.isArray(blogData.tags) ? blogData.tags.join(', ') : blogData.tags || '',
//                     category: blogData.category || '',
//                     metaTitle: blogData.metaTitle || '',
//                     metaDescription: blogData.metaDescription || '',
//                     contentHtml: blogData.contentHtml || '',
//                     contentJson: typeof blogData.contentJson === 'string' ? blogData.contentJson : JSON.stringify(blogData.contentJson, null, 2),
...
//             if (formData.contentJson) submitData.append('contentJson', formData.contentJson);
...
//                                                     <p className="text-sm text-gray-600 truncate">{existingCoverImage}</p>
//                                                     <button
//                                                         type="button"
...
//                                                 {existingCoverImage ? 'Upload new image to replace current' : 'Upload cover image'}
//                                             </p>
//                                         </div>
//                                     </div>
//                                 </div>
...
//                                                 <p className="text-sm text-gray-600">Existing Images ({existingImages.length}):</p>
...
const BlogDetails = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Append new images - FIXED: Check if images exists and has length property
            if (formData.images && Array.isArray(formData.images)) {
                formData.images.forEach(image => {
                    if (image) { // Check if image is not null/undefined
                        submitData.append('images', image);
                    }
                });
            }
